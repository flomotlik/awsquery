...
class TestTagsPerformance:
    ...
    def test_large_tag_set_transformation(self):
        ...
        large_tags = [
            {"Key": f"Tag{i:04d}", "Value": f"Value{i:04d}"}
            for i in range(1000)
        ]
...
class TestTagsErrorHandling:
    ...
    def test_malformed_tag_entries(self):
        ...
        expected_tags = {
            "ValidTag": "ValidValue",
            "EmptyValue": ""  # Empty values are allowed
        }
