...
from src.awsquery.cli import main, determine_column_filters
    ...
    def test_multi_level_call_uses_session(self, mock_get_client):
        ...
        with patch('src.awsquery.core.execute_aws_call') as mock_execute:
            ...
            execute_multi_level_call(
                ...
                dry_run=False, session=mock_session
            )
    ...
    def test_session_debug_with_empty_values(self, mock_debug):
        ...
        try:
            with patch('boto3.Session'):
                ...
                add_calls = [call for call in mock_debug.call_args_list
                           if 'Added' in str(call)]
