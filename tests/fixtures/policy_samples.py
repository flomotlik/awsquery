"""
Sample security policy fixtures for comprehensive testing scenarios.

This module provides various AWS IAM policy configurations for testing
security validation with different permission levels and patterns.
"""
...
def get_readonly_policy():
    """
    Standard AWS ReadOnlyAccess policy for testing normal operation.
    
    Returns:
        Dictionary representing a comprehensive read-only IAM policy
    """
    return {
        "PolicyVersion": {
            "Document": {
