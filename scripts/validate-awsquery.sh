...
run_test "EC2: describe-instances with columns" "$BASE_CMD ec2 describe-instances -- InstanceId State.Name"
...
run_test "EC2: describe-instances --keys" "$BASE_CMD ec2 describe-instances --keys"
run_test "EC2: describe-network-interfaces" "$BASE_CMD ec2 describe-network-interfaces"
run_test "EC2: describe-security-groups" "$BASE_CMD ec2 describe-security-groups"
run_test "EC2: describe-vpcs" "$BASE_CMD ec2 describe-vpcs"
run_test "EC2: describe-subnets" "$BASE_CMD ec2 describe-subnets"
run_test "EC2: describe-volumes" "$BASE_CMD ec2 describe-volumes"
run_test "EC2: describe-snapshots" "$BASE_CMD ec2 describe-snapshots -p OwnerIds=self"
run_test "EC2: describe-images" "$BASE_CMD ec2 describe-images -p Owners=self"
...
run_test "Lambda: list-functions with columns" "$BASE_CMD lambda list-functions -- FunctionName Runtime"
...
echo "--- S3 Tests ---"
run_test "S3: list-buckets" "$BASE_CMD s3 list-buckets"
...
run_test "IAM: list-roles" "$BASE_CMD iam list-roles"
...
run_test "Advanced: debug mode" "$BASE_CMD ec2 describe-instances --debug"
